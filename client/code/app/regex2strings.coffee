...
handleString=(string)-> console.log string

generate=(rest, prefix='', cb=handleString)->
    return cb prefix unless rest
    ...
    if rest[0] is '['
        ...
        generate option+rest, prefix, cb for option in options
        return 1
    else
        chars = rest[0]
        rest = rest[1..]
    ...
    if rest[0] is '{'
        ...
        generate rest, prefix+c, cb for c in charsIn chars
